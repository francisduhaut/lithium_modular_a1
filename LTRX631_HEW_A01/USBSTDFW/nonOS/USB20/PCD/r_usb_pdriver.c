...
uint16_t usb_pstd_GetInterfaceNum(uint16_t con_num)
{
    ...
    /* Interface number */
    return (uint16_t)(*(uint8_t*)((uint32_t)usb_gpstd_Driver.configtbl[conf - 1u] + (uint16_t)4u));
}
/******************************************************************************
...
uint16_t usb_pstd_GetAlternateNum(uint16_t con_num, uint16_t int_num)
{
    ...
    length = (uint16_t)(*(uint8_t*)((uint32_t)  usb_gpstd_Driver.configtbl[conf-1u] + (uint16_t)2u));
    length |= (uint16_t)((uint16_t)(*(uint8_t*)((uint32_t)usb_gpstd_Driver.configtbl[conf-1u] + (uint16_t)3u)) << 8u);
...
uint16_t usb_pstd_ChkRemote(void)
{
    ...
    atr = *(uint8_t*)((uint32_t)usb_gpstd_Driver.configtbl[usb_gpstd_ConfigNum - 1u] + (uint32_t)7u);
...
uint8_t usb_pstd_GetCurrentPower(void)
{
    ...
    tmp = *(uint8_t*)((uint32_t)usb_gpstd_Driver.configtbl[(conf - 1u)] + (uint32_t)7u);
