...
#elif (!defined(__BIG))||(defined(__LIT))
...
***********************************************************************************/
/* Boolean type */
//typedef enum { TFAT_FALSE = 0, TFAT_TRUE } BOOL;  // commnet for uITRON
...
extern DSTATUS R_tfat_disk_initialize (void);
